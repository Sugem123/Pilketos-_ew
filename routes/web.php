...
Route::middleware(['auth', 'desktop'])->prefix('admin')->group(function () {
    ...
    Route::get('/audit-suara', [\App\Http\Controllers\AuditSuaraController::class, 'index'])->name('audit-suara.index');
    Route::patch('/audit-suara/{vote}', [\App\Http\Controllers\AuditSuaraController::class, 'verifySingle'])->name('audit-suara.verify-single');
    Route::post('/audit-suara/quick-verify', [\App\Http\Controllers\AuditSuaraController::class, 'quickVerifyByToken'])->name('audit-suara.quick-verify');
    Route::post('/audit-suara/batch-verify', [\App\Http\Controllers\AuditSuaraController::class, 'batchVerifyAll'])->name('audit-suara.batch-verify');

    // Cetak Dokumen Resmi Pemilihan
    Route::get('/cetak/undangan', [\App\Http\Controllers\PrintController::class, 'undangan'])->name('cetak.undangan');
    Route::get('/cetak/kartu', [\App\Http\Controllers\PrintController::class, 'kartu'])->name('cetak.kartu');
    Route::get('/cetak/berita-acara', [\App\Http\Controllers\PrintController::class, 'beritaAcara'])->name('cetak.berita-acara');
